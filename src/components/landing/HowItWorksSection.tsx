        ...
        <div className="relative max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
            {steps.map((step, index) => (
              ...
              >
                {/* Card */}
                <div className="relative bg-neutral-950/80 backdrop-blur-sm border border-neutral-800/50 rounded-2xl p-8 lg:p-10 transition-all duration-500 hover:bg-neutral-950 hover:border-amber-500/30 hover:-translate-y-2 hover:shadow-2xl hover:shadow-amber-500/20">
                  {/* Gradient Overlay */}
                  ...
                  <div className="absolute -top-4 -right-4">
                    <div
                      className={`w-16 h-16 rounded-xl bg-gradient-to-br ${step.color} flex items-center justify-center shadow-lg group-hover:scale-110 group-hover:rotate-6 transition-all duration-500`}
                    >
                  ...
                  <div className="relative mb-8">
                    <div
                      className={`w-20 h-20 rounded-2xl bg-gradient-to-br ${step.color} bg-opacity-10 border border-amber-500/20 flex items-center justify-center group-hover:scale-110 transition-all duration-500`}
                    >
                      <step.icon className="w-10 h-10 text-amber-400 group-hover:text-amber-300 transition-colors" />
                    </div>

                    <div
                      className={`absolute inset-0 w-20 h-20 ${step.bgGlow} rounded-2xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500`}
                    />
                  </div>

                  {/* Content */}
                  <div className="relative">
                    <h3 className="text-2xl font-bold text-white mb-4 group-hover:text-amber-50 transition-colors">
                      {step.title}
                    </h3>
                ...
                {index < steps.length - 1 && (
                  <div className="lg:hidden flex justify-center my-6">
                    <div className="w-12 h-12 rounded-full bg-neutral-900 border border-amber-500/30 flex items-center justify-center rotate-90">
                      <ArrowRight className="w-6 h-6 text-amber-400" />
                    </div>
                  </div>
                )}
